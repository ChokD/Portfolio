...
export default function Certificates({ isDarkMode }: CertificatesProps) {
  const certificates = [
    {
      ...
      issuer: "Samsung",
      date: "Jul, 2025",
      image: "/images/THANARUT RUNGRUANGWISETCHAI - 2025-07-08_page-0001.jpg",
    },
    {
      title: "Customer Service with Python: Build a Chatbot using ChatGPT",
      issuer: "Coursera",
      date: "Apr, 2025",
      image: "/images/Coursera UENCHXP85LLL_page-0001.jpg",
    },
    {
  ...
  return (
    <section id="certificates" className={`py-28 transition-colors duration-300 ${isDarkMode ? 'bg-gray-900' : 'bg-sky-50'}`}>
